<div class="admin1" style="background-image:url(IMG/white-wallpaper-14.jpg)">
	<div class=content3>
		<div>
			...
			$tong = $row['tong'];
			?>
			<a align="center" style="width: 100%;" href="productman.php">
				<p><span>Số lượng sản phẩm: </span><?php echo $tong; ?></p>
			</a>
			<?php
			...
			$tong = $row['tong'];
			?>
			<a align="center" style="width: 100%;" href="#het-hang">
				<p><span>Sản phẩm sắp hết (hết hàng): </span><?php echo $tong; ?></p>
			</a>
