...
<?php 
	if(isset($_SESSION['admin'])) {
		...
		$loainv = $row['loainv'];
?>
	<div class=content2 style="width: 100%; margin: 0px;">
		<a class="admin" href="accman.php" rel="noopener noreferrer" onClick="return quyen1();">Quản lý tài khoản</a>
		<a class="admin" href="doanhthu.php" rel="noopener noreferrer" onClick="return quyen1();">Thống kê doanh thu</a>
		<a class="admin" href="proman.php" rel="noopener noreferrer" onClick="return quyen2();">Quản lý kho hàng</a>
		<a class="admin" href="proman1.php" rel="noopener noreferrer" onClick="return quyen2();">Quản lý danh mục</a>
